    ...
    <div className="p-6">
      ...
      {user.role === 'finance' || user.role === 'admin' ? (
        <div>
          ...
          <div className="mt-2">
            <button onClick={() => navigate('/finance/create')} className="px-3 py-1 bg-green-600 text-white rounded-md">Create Invoice</button>
          </div>
        </div>
      ) : (
        <div>
          ...
          <div className="mt-2">
            <button onClick={() => navigate('/finance/invoices')} className="px-3 py-1 bg-indigo-50 text-indigo-700 rounded">View Invoices</button>
          </div>
        </div>
      )}
    </div>
